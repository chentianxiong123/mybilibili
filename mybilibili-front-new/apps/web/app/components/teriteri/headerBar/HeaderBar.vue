<template>
    <div class="header-bar" :class="isFixHeaderBar ? 'slide-down' : ''">
        ...
        <div class="left-entry">
            ...
            >
                <picture class="logo">
                    <img src="@/assets/teriteri/img/teriteri-pink.png" alt="">
                </picture>
                <span>首页</span>
                            ...
                            <div class="trendings-col" style="max-width: calc(50% - 5px);">
                                ...
                                >
                                    <div class="trending-wrap"  @click.stop="clickItemToSearch(item.content)">
                                        ...
                                        <img src="@/assets/teriteri/img/icon_new.png" alt="" class="trending-mark" v-if="item.type === 1">
                                        <img src="@/assets/teriteri/img/icon_hot.png" alt="" class="trending-mark" v-if="item.type === 2">
                                    </div>
                                </div>
                            </div>
                            <div class="trendings-col" style="max-width: calc(50% - 5px);">
