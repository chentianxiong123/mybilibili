...
const permissionGroupRules = [
  { title: '运营', codes: ['operation:manage', 'search:manage', 'statistics:manage', 'scheduled:manage'] },
  { title: '内容审核', codes: ['review:manage', 'comment:manage'] },
  { title: 'AI', codes: ['ai:manage'] },
  { title: '媒体', codes: ['video:manage', 'category:manage', 'banner:manage', 'live:manage', 'subtitle:manage'] },
  { title: '系统', codes: ['admin:manage', 'role:manage', 'security:manage', 'audit:manage', 'transcode:manage', 'storage:manage'] },
  { title: '用户', codes: ['user:manage', 'message:manage'] },
  { title: '其他', codes: [] }
]
