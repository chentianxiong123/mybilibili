...
public class JwtFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        // 检查是否是公开接口
        boolean isPublicPath = path.contains("/user/register") || path.contains("/user/login") || 
            path.matches(".*/user/\\d+(/following|/followers)?$") || 
            ...
            path.contains("/comment/list") || path.contains("/comment/video/") ||
            path.matches(".*/comment/\\d+/replies$") ||
        ...
        System.out.println("Is public path: " + isPublicPath + " for path: " + path);
