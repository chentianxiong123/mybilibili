...
public interface CreatorStatsMapper {
     ...
     * @return 总弹幕数
     */
    Integer sumDanmakuCount(@Param("userId") Integer userId);
     ...
     * @return 统计数据
     */
    Map<String, Integer> selectDayStats(@Param("userId") Integer userId, @Param("date") String date);
     ...
     * @return 排行列表
     */
    List<RankingVO> selectRankingByLikes(@Param("userId") Integer userId, @Param("limit") Integer limit);
     ...
     * @return 排行列表
     */
    List<RankingVO> selectRankingByComments(@Param("userId") Integer userId, @Param("limit") Integer limit);
}
