...
public class ManuscriptServiceImpl implements ManuscriptService {
    ...
    @Override
    public List<ManuscriptVO> getManuscriptsByCategoryId(Integer categoryId) {
        ...
        for (Manuscript manuscript : manuscripts) {
            ...
            if (!videos.isEmpty()) {
                vo.setFirstVideoId(videos.get(0).getId());
                vo.setFirstVideoPlayUrl(videos.get(0).getPlayUrl());
            }
