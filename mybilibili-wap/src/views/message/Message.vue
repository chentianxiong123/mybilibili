...
<template>
  <div class="message-page">
    ...
    <div class="category-tabs">
      <div class="tab-item" @click="router.push('/m/message/notify/reply')">
      ...
      <div class="tab-item" @click="router.push('/m/message/notify/like')">
      ...
      <div class="tab-item" @click="router.push('/m/message/notify/system')">
