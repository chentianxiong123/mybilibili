...
import { meetingApi as defaultMeetingApi } from '@/api/meeting.ts'
import { createReconnectingWS as defaultCreateReconnectingWS } from '@/utils/reconnectingWs.ts'
import { getMeetingJoinBlockMessage as defaultJoinBlockMessage } from '@/utils/liveMeetingStatus.ts'
...
export function useMeetingRoomSession({
  ...
  confirm = (...args: any[]) => (ElMessageBox.confirm as any)(...args),
  logger = console
}) {
  let ws = null
